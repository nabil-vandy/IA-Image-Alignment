...
\
# Page Config\
st.set_page_config(page_title="ImageAssist AI Alignment", page_icon="\uc0\u55357 \u56568 ")\
\
...
if uploaded_file is not None:\
    ...
    if results.multi_face_landmarks:\
        ...
        \
        st.success("\uc0\u9989  Reference Processed! Scroll down to start camera.")\
        st.image(ref_img, caption="Reference Photo", width=300)\
    else:\
        st.error("\uc0\u10060  No face detected in reference photo. Try another.")\
\
...
if st.session_state['ref_nose_pos'] is not None:\
    st.write("### \uc0\u55356 \u57253  Live Alignment Guide")\
    webrtc_streamer(key="alignment", video_transformer_factory=VideoProcessor)}
